    ...
    <MobileNavProvider>
      <div className="flex min-h-screen">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <Header />
          {/* flex-1 is what gives the default <Loading /> its height: the
              browser has already computed "screen minus header" here, which a
              fixed vh never gets right — least of all when the header wraps. */}
